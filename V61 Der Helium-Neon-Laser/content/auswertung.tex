...
%
Wie in Abschnitt~\ref{sec:theorie} beschrieben, ist der hier verwendete Laser optisch nur dann stabil, wenn das Produkt $g_1\cdot g_2\in[0,1)$ ist. Daher lassen sich Bedingungen an den Abstand der Resonatorspiegel stellen. Im ersten Versuchsteil werden zwei konkave Spiegel mit dem Krümmungsradius $\SI{140}{\centi\meter}$ verwendet. Über den Zusammenhang
%
\begin{equation}
...
Abbildung~\ref{fig:opt_stab}. Für die Konfiguration aus einem konkaven und einem planaren Spiegel (Krümmungsradius $r=\infty$) gilt dementsprechend
%
\begin{equation}
  L_1=r_2\; , \quad L_2=0 \; .
\end{equation}
%
Daraus folgt, dass der Stabilitätsbereich zwischen~\SI{0}{\centi\metre} und~$r_2$ \si{\centi\metre} liegt.
...
Da die hier verwendete optische Bank lediglich $\SI{250}{\centi\meter}$ lang ist, kann für die beiden konkaven Spiegel nur überprüft werden, ob die optische Stabilität am
...
dargestellt. Es zeigt sich hierbei, dass der Laser über die zwei konkaven Spiegel bis etwa $\SI{1300}{\milli\meter}$ ununterbrochen mit hoher Leistung funktioniert.
Die Verteilung der Intensität zeigt hierbei allerdings auch deutlich das angesprochene Problem: Die Schwankungen der Intensität aufgrund
...
durchführbar ist. Aufgrund der hohen Schwankungen wurde auf die Aufnahme einer Messreihe für einen konkaven und einen planaren Spiegel verzichtet.

\begin{figure}[htb]
  \centering
  \includegraphics[width=0.8\textwidth]{auswertung/plot_kk.pdf}
  \caption{Konfiguration: Zwei konkave Spiegel des Krümmungsradius $r=\SI{140}{\centi\meter}$. Darstellung der an der Photodiode gemessenen Stromstärke als Maß für die Intensität des Laserlichtes in Abhängigkeit der Resonatorlänge. Es zeigen sich klar die großen Schwankungen aufgrund der experimentellen Ungenauigkeiten.}
  \label{fig:kk}
\end{figure}
%
...
Mode dar, in welcher der Laser hauptsächlich schwingt und die geringsten Verluste entstehen. Die Intensität des Lichtes an verschiedenen Punkten einer auf Höhe der Photodiode liegenden
...
\end{table}
%
Die Verteilung dieser Intensität folgt dabei dem Zusammenhang~\cite{tem10}
%
\begin{equation}
