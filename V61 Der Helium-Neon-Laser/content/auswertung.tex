...
%
Wie in Abschnitt~\ref{sec:theorie} beschrieben, ist der hier verwendete Laser optisch nur dann stabil, wenn das Produkt~$g_1\cdot g_2\in[0,1)$ ist. Daher lassen sich Bedingungen an den Abstand der Resonatorspiegel stellen. Im ersten Versuchsteil werden zwei konkave Spiegel mit einem Krümmungsradius von jeweils~$\SI{140}{\centi\meter}$ verwendet. Über den Zusammenhang
%
\begin{equation}
...
\end{figure}
%
Da die hier verwendete optische Bank lediglich~$\SI{250}{\centi\meter}$ lang ist, kann hier nur überprüft werden, ob die optische Stabilität am
...
\end{align*}
%
Die Intensitätsverteilungen für die beiden betrachteten Moden spiegeln insgesamt ein gutes Bild der stehenden Wellen wieder. Die Winkelverteilung
